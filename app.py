...
st.set_page_config(page_title="ResumeBooster.ai", layout="wide")

# App title and description
st.title("ResumeBooster.ai")
...
st.sidebar.markdown(
    ...
    <p style="text-align: center; font-size: 12px; color: #888;">
        <small>Created with ❤️ by <a href="https://www.linkedin.com/in/kishorelenka/" target="_blank" style="color: #0078D4;">Kishore Lenka</a></small>
    </p>
    """,
